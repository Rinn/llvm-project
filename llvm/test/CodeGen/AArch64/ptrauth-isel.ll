...
define i64 @blend_and_auth_same_bb(i64 %addr) {
  ...
  ; DAGISEL-ELF-NEXT:   [[AUTxMxN:%[0-9]+]]:gpr64, early-clobber [[AUTxMxN1:%[0-9]+]]:gpr64common = AUTxMxN [[COPY]], 2, 42, killed [[COPY1]], implicit-def dead $nzcv
  ...
  ; GISEL-ELF-NEXT:   [[AUTxMxN:%[0-9]+]]:gpr64, early-clobber [[AUTxMxN1:%[0-9]+]]:gpr64common = AUTxMxN [[COPY]], 2, 42, [[COPY1]], implicit-def dead $nzcv
...
define i64 @blend_and_auth_different_bbs(i64 %addr, i64 %cond) {
  ...
  ; DAGISEL-ELF-NEXT:   [[AUTxMxN:%[0-9]+]]:gpr64, early-clobber [[AUTxMxN1:%[0-9]+]]:gpr64common = AUTxMxN [[COPY1]], 2, 42, [[COPY4]], implicit-def dead $nzcv
  ; DAGISEL-ELF-NEXT:   $x0 = COPY [[AUTxMxN]]
  ; DAGISEL-ELF-NEXT:   RET_ReallyLR implicit $x0
  ;
  ...
  ; GISEL-ELF-NEXT:   [[AUTxMxN:%[0-9]+]]:gpr64, early-clobber [[AUTxMxN1:%[0-9]+]]:gpr64common = AUTxMxN [[COPY]], 2, 42, [[COPY3]], implicit-def dead $nzcv
  ; GISEL-ELF-NEXT:   $x0 = COPY [[AUTxMxN]]
  ; GISEL-ELF-NEXT:   RET_ReallyLR implicit $x0
entry:
  %addrdisc = load i64, ptr @discvar
